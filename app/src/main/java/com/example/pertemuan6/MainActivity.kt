...
//            Initiate
            var selectedTime = String.format("%02d:%02d", timePicker.hour, timePicker.minute)
            ...
            datepicker.init(
                ...
                OnDateChangedListener { view, year, monthOfYear, dayOfMonth ->
                    selectedDate = dayOfMonth.toString() + " " + (monthList[_tempCalendar.get(Calendar.MONTH)]) +
                            " " + year
                }
            )
                ...
                object : AdapterView.OnItemSelectedListener {
                    override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                        if(kehadiranSpinner.selectedItem.toString() == "Hadir tepat waktu") {
                            keteranganEdittext.visibility = android.view.View.GONE
                        }
                        else {
                            keteranganEdittext.visibility = android.view.View.VISIBLE
                        }
                    }
